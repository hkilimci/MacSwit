...
/// Errors that can occur during Tuya API communication.
...
/// Actor that manages communication with the Tuya Cloud REST API.
///
/// Handles token acquisition, HMAC-SHA256 request signing, device status
/// queries, and on/off commands in a thread-safe manner. Caches tokens
