...
/// Persistent store for smart plug configurations.
///
/// Persists the plug list in `UserDefaults` and sensitive credentials
/// (Access ID / Secret) in `KeychainStore`. Provides CRUD operations,
/// active plug selection, and Keychain integration.
@MainActor
