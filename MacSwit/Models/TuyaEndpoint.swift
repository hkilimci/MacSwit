...
/// Tuya Cloud API regional endpoint definition.
///
/// Each region (China, Europe, America, etc.) has a different `host`.
/// The user can pick a preset region or enter a custom endpoint.
